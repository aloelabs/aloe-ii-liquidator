...
function scan(borrowers) {
    const promise = Promise.all(borrowers.map((borrower) => __awaiter(this, void 0, void 0, function* () {
        ...
        const solvent = yield isSolvent(borrower);
        if (!solvent) {
...
function isSolvent(borrower) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log("Checking solvency or something");
            yield LIQUIDATOR_CONTRACT.methods.liquidate(borrower, "0x0", 1).estimateGas({ gasLimit: 3000000 });
            console.log("Borrower is insolvent!");
            return false;
        }
        catch (e) {
            winston_1.default.log("info", `Borrower ${borrower} is solvent!`);
